...
layui.define(['jquery', 'layer'], function(exports) { //Tip：模块也可以依赖其它模块，如：layui.define('layer', callback);
	"use strict";
	var jquery = layui.jquery,
		layer = layui.layer,
		        baseurl = "http://localhost:8088/springboot4c04d/";
        	var http = {
		        domain : "http://localhost:8088/springboot4c04d/",
        		baseurl: baseurl,
		/**
		 * 获取传递参数值(修改支持中文)
		 */
